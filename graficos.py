...
axs[0,0].plot(tempo, xcm, label='x_cm')
axs[0,0].plot(tempo, ycm, label='y_cm')
axs[0,0].set_xlabel('Tempo (s)')
axs[0,0].set_ylabel('Posição (cm)')
axs[0,0].set_title('Posições do Centro de Massa (CM)')
axs[0,0].legend()
axs[0,0].grid(True)

# Plotando as posições do pé esquerdo
axs[0,1].plot(tempo, pe_esq_x, label='x_esq')
axs[0,1].plot(tempo, pe_esq_y, label='y_esq')
axs[0,1].plot(tempo, pe_esq_z, label='z_esq')
axs[0,1].set_xlabel('Tempo (s)')
axs[0,1].set_ylabel('Posição (cm)')
axs[0,1].set_title('Posições do Pé Esquerdo')
axs[0,1].legend()
axs[0,1].grid(True)

# Plotando as posições do pé direito
axs[1,0].plot(tempo, pe_dir_x, label='x_dir')
axs[1,0].plot(tempo, pe_dir_y, label='y_dir')
axs[1,0].plot(tempo, pe_dir_z, label='z_dir')
axs[1,0].set_xlabel('Tempo (s)')
axs[1,0].set_ylabel('Posição (cm)')
axs[1,0].set_title('Posições do Pé Direito')
axs[1,0].legend()
axs[1,0].grid(True)
